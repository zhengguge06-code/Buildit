...
export default async function SignUpPage() {
  ...
  return (
    <div className="grid min-h-[calc(100vh-4rem)] lg:grid-cols-2">
      <aside className="relative hidden overflow-hidden bg-gradient-to-br from-accent/12 via-card to-primary/10 lg:flex lg:flex-col lg:justify-between lg:p-14">
        <div className="absolute right-[-6rem] top-[-6rem] h-80 w-80 rounded-full bg-accent/15 blur-3xl" />
        <div className="absolute bottom-[-4rem] left-[-4rem] h-72 w-72 rounded-full bg-primary/15 blur-3xl" />
